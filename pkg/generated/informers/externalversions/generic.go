...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=fogatlas.fbk.eu, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("dynamicnodes"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Fogatlas().V1alpha1().DynamicNodes().Informer()}, nil
	...
	case v1alpha1.SchemeGroupVersion.WithResource("regions"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Fogatlas().V1alpha1().Regions().Informer()}, nil
