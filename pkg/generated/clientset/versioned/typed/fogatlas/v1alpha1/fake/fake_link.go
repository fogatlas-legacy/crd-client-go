...
var linksResource = schema.GroupVersionResource{Group: "fogatlas.fbk.eu", Version: "v1alpha1", Resource: "links"}

var linksKind = schema.GroupVersionKind{Group: "fogatlas.fbk.eu", Version: "v1alpha1", Kind: "Link"}
...
func (c *FakeLinks) UpdateStatus(link *v1alpha1.Link) (*v1alpha1.Link, error) {
	obj, err := c.Fake.
