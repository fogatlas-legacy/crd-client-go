...
// FakeDynamicNodes implements DynamicNodeInterface
type FakeDynamicNodes struct {
	Fake *FakeFogatlasV1alpha1
	ns   string
}

var dynamicnodesResource = schema.GroupVersionResource{Group: "fogatlas.fbk.eu", Version: "v1alpha1", Resource: "dynamicnodes"}
...
func (c *FakeDynamicNodes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DynamicNode, err error) {
	...
	return obj.(*v1alpha1.DynamicNode), err
}
...
func (c *FakeDynamicNodes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DynamicNodeList, err error) {
	...
	list := &v1alpha1.DynamicNodeList{ListMeta: obj.(*v1alpha1.DynamicNodeList).ListMeta}
	for _, item := range obj.(*v1alpha1.DynamicNodeList).Items {
