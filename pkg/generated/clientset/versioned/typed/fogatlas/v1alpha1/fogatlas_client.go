...
import (
	...
	"github.com/fogatlas/crd-client-go/pkg/generated/clientset/versioned/scheme"
...
func (c *FogatlasV1alpha1Client) DynamicNodes(namespace string) DynamicNodeInterface {
	return newDynamicNodes(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*FogatlasV1alpha1Client, error) {
	...
	return &FogatlasV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new FogatlasV1alpha1Client for the given config and
...
func New(c rest.Interface) *FogatlasV1alpha1Client {
	return &FogatlasV1alpha1Client{c}
}
