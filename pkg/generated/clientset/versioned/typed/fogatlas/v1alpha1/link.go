...
type LinkInterface interface {
	...
	UpdateStatus(*v1alpha1.Link) (*v1alpha1.Link, error)
...
func newLinks(c *FogatlasV1alpha1Client, namespace string) *links {
	return &links{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *links) UpdateStatus(link *v1alpha1.Link) (result *v1alpha1.Link, err error) {
	result = &v1alpha1.Link{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("links").
